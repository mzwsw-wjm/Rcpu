...
#
# Generated by export_simulation on Tue Apr 26 20:07:42 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './DataPath_more_0.sh' script.

./DataPath_more_0.sh -reset_run
...
./DataPath_more_0.sh -noclean_files

For more information on the script, please type './DataPath_more_0.sh -help'.
