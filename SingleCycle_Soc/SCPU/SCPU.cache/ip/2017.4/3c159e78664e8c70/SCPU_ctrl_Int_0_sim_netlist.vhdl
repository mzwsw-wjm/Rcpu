...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute SOFT_HLUTNM of \ALU_Control[1]_INST_0_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ALU_Control[1]_INST_0_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \ALU_Control[1]_INST_0_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ALU_Control[2]_INST_0_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \ALU_Control[3]_INST_0_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of BranchN_INST_0_i_1 : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of ill_instr_INST_0_i_1 : label is "soft_lutpair0";
begin
  CPU_MIO <= 'Z';
...
\ALU_Control[1]_INST_0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\ALU_Control[1]_INST_0_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
\ALU_Control[1]_INST_0_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
BranchN_INST_0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAAAA8"
    )
        port map (
...
BranchN_INST_0_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
Branch_INST_0_i_2: unisim.vcomponents.LUT6
    generic map(
...
ill_instr_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EA3EFEFE"
    )
        port map (
