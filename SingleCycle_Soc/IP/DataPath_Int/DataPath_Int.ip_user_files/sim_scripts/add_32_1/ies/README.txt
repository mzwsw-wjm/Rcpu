...
#
# Generated by export_simulation on Sun Apr 10 18:58:47 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './add_32_1.sh' script.

./add_32_1.sh -reset_run
...
./add_32_1.sh -noclean_files

For more information on the script, please type './add_32_1.sh -help'.
