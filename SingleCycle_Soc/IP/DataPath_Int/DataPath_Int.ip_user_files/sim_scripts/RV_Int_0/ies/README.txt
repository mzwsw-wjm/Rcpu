...
#
# Generated by export_simulation on Tue Apr 26 20:06:52 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './RV_Int_0.sh' script.

./RV_Int_0.sh -reset_run
...
./RV_Int_0.sh -noclean_files

For more information on the script, please type './RV_Int_0.sh -help'.
