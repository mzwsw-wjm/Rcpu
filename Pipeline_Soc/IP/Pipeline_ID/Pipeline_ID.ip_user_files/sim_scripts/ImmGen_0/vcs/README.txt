...
#
# Generated by export_simulation on Fri May 13 14:09:52 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './ImmGen_0.sh' script.

./ImmGen_0.sh -reset_run
...
./ImmGen_0.sh -noclean_files

For more information on the script, please type './ImmGen_0.sh -help'.
