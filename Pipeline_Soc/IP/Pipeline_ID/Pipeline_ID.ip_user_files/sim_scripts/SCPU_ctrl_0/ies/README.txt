...
#
# Generated by export_simulation on Fri May 13 14:09:39 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './SCPU_ctrl_0.sh' script.

./SCPU_ctrl_0.sh -reset_run
...
./SCPU_ctrl_0.sh -noclean_files

For more information on the script, please type './SCPU_ctrl_0.sh -help'.
