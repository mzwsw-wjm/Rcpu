...
#
# Generated by export_simulation on Thu May 19 14:29:34 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './REG32_0.sh' script.

./REG32_0.sh -reset_run
...
./REG32_0.sh -noclean_files

For more information on the script, please type './REG32_0.sh -help'.
