...
#
# Generated by export_simulation on Fri May 13 15:52:51 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Pipeline_Mem_0.sh' script.

./Pipeline_Mem_0.sh -reset_run
...
./Pipeline_Mem_0.sh -noclean_files

For more information on the script, please type './Pipeline_Mem_0.sh -help'.
