...
#
# Generated by export_simulation on Fri May 13 15:51:49 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Mem_reg_WB_0.sh' script.

./Mem_reg_WB_0.sh -reset_run
...
./Mem_reg_WB_0.sh -noclean_files

For more information on the script, please type './Mem_reg_WB_0.sh -help'.
