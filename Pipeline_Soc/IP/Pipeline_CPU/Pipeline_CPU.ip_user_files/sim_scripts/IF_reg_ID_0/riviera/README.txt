...
#
# Generated by export_simulation on Thu Jun 02 22:28:33 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './IF_reg_ID_0.sh' script.

./IF_reg_ID_0.sh -reset_run
...
./IF_reg_ID_0.sh -noclean_files

For more information on the script, please type './IF_reg_ID_0.sh -help'.
