...
#
# Generated by export_simulation on Tue May 17 22:20:55 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Ex_reg_Mem_0.sh' script.

./Ex_reg_Mem_0.sh -reset_run
...
./Ex_reg_Mem_0.sh -noclean_files

For more information on the script, please type './Ex_reg_Mem_0.sh -help'.
