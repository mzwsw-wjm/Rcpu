...
#
# Generated by export_simulation on Fri May 13 15:53:06 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Pipeline_WB_0.sh' script.

./Pipeline_WB_0.sh -reset_run
...
./Pipeline_WB_0.sh -noclean_files

For more information on the script, please type './Pipeline_WB_0.sh -help'.
