...
#
# Generated by export_simulation on Fri May 13 15:51:21 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './ID_reg_Ex_0.sh' script.

./ID_reg_Ex_0.sh -reset_run
...
./ID_reg_Ex_0.sh -noclean_files

For more information on the script, please type './ID_reg_Ex_0.sh -help'.
