...
#
# Generated by export_simulation on Thu Jun 02 22:28:04 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Pipeline_IF_0.sh' script.

./Pipeline_IF_0.sh -reset_run
...
./Pipeline_IF_0.sh -noclean_files

For more information on the script, please type './Pipeline_IF_0.sh -help'.
