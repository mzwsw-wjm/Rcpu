...
#
# Generated by export_simulation on Wed May 18 13:53:56 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Pipeline_Ex_0.sh' script.

./Pipeline_Ex_0.sh -reset_run
...
./Pipeline_Ex_0.sh -noclean_files

For more information on the script, please type './Pipeline_Ex_0.sh -help'.
