...
#
# Generated by export_simulation on Thu May 19 13:18:03 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './stall_0.sh' script.

./stall_0.sh -reset_run
...
./stall_0.sh -noclean_files

For more information on the script, please type './stall_0.sh -help'.
