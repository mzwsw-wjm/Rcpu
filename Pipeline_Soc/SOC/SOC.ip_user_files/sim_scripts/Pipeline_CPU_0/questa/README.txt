...
#
# Generated by export_simulation on Thu May 19 15:10:13 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Pipeline_CPU_0.sh' script.

./Pipeline_CPU_0.sh -reset_run
...
./Pipeline_CPU_0.sh -noclean_files

For more information on the script, please type './Pipeline_CPU_0.sh -help'.
